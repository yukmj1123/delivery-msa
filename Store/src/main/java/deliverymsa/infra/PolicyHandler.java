...
public class PolicyHandler{
    ...
    @StreamListener(value=KafkaProcessor.INPUT, condition="headers['type']=='Reviewed'")
    public void wheneverReviewed_Notify(@Payload Reviewed reviewed){

        Reviewed event = reviewed;
        System.out.println("\n\n##### listener Notify : " + reviewed + "\n\n");


        

        // Sample Logic //
        FoodCooking.notify(event);
